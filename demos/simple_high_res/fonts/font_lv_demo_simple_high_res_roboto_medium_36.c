 ...
 * Size: 36 px
 * Bpp: 8
 * Opts: --bpp 8 --size 36 --no-compress --font Roboto-Medium.ttf --range 32-127,176 --format lvgl -o font_lv_demo_simple_high_res_roboto_medium_36.c
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_lv_demo_simple_high_res_roboto_medium_36 = {
#else
lv_font_t font_lv_demo_simple_high_res_roboto_medium_36 = {
#endif
