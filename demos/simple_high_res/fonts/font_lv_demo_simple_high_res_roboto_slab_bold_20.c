 ...
 * Size: 20 px
 * Bpp: 8
 * Opts: --bpp 8 --size 20 --no-compress --font RobotoSlab-Bold.ttf --range 32-127,176 --format lvgl -o font_lv_demo_simple_high_res_roboto_slab_bold_20.c
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_lv_demo_simple_high_res_roboto_slab_bold_20 = {
#else
lv_font_t font_lv_demo_simple_high_res_roboto_slab_bold_20 = {
#endif
